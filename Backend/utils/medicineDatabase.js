...
export const VERIFIED_MEDICINES = [
  ...
  },
  {
    ...
    defaultPrecautions: [
      ...
      'Avoid antacids containing aluminum or magnesium within 2 hours of administration.',
  ...
  },
  {
    ...
    warnings: [
      'Seek emergency emergency care immediately if breathing difficulty is not relieved within 15 minutes of use.'
    ]
  },
  {
...
/**
 * Searches the verified database for matching medicine entries based on OCR text
 */
...
/**
 * Intelligent Generic OCR Fallback Parser
 * Synthesizes a structured clinical profile for any scanned medicine label if no exact match exists in pre-indexed dictionary.
 */
export const parseGenericMedicineFromText = (rawText) => {
  ...
  // Extract strength pattern (e.g., 500mg, 10mg, 100mcg, 5ml, 250mg)
  ...
  // Extract primary name candidate from non-generic words
  ...
  // Determine drug category & problems treated using keyword inference
  let drugClass = 'Pharmaceutical Therapeutic Agent';
  let category = 'General Therapeutics';
